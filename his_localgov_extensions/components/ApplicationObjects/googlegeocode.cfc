<cfcomponent displayname="googlegeoCode" hint="provides an interface to the Google Geocoding service. Providing an address, the service can return information about the address including longitude and latitude information." extends="his_Localgov_Extends.components.ApplicationObjects.utils">
	<!--- ------------------------------------------------------------------------------------------------------------------------------------------------------------------->
	<!--- ------------------------------------------------------------------------------------------------------------------------------------------------------------------->
	<!--- ------------------------------------------------------------------------------------------------------------------------------------------------------------------->
	<cffunction name="geocode" returnType="struct" output="false">
		...
		<cfargument name="useProxy" type="boolean" required="no" hint="">
		...
		<cfset httpResult =super.http(baseURL, arguments.useProxy)>
