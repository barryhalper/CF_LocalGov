...
<cfcomponent displayname="ArticleDAO" hint="Article-related data access methods" extends="his_Localgov_Extends.components.DAOManager">
	...
	<cffunction name="getNewsHome" access="public" returntype="struct" hint="retrieve all content required for the news home page">		
		...
		<cfstoredproc  datasource="#variables.DSN1#" procedure="usp_GetLocalGovNewsHome">
	...
	<!--- -------------------------------------------------------------------------------------------------->
	<!--- -------------------------------------------------------------------------------------------------->
	<cffunction name="getNewsHomeForSector" access="public" returntype="struct" hint="retrieve all content required for the news home page">		
		<cfargument name="sectorid"   required="yes"  	type="numeric" 	>
		<cfset var strContent = StructNew()> 
		
		<cfstoredproc  datasource="#variables.DSN1#" procedure="usp_GetLocalGovNewsHomebySector">
        	 <cfprocparam cfsqltype="cf_sql_integer" type="in" dbvarname="@SectorID" value="#arguments.sectorid#">
             <cfprocparam cfsqltype="cf_sql_varchar"  type="out" dbvarname="@Sector"  variable="strContent.sector">
			<cfprocresult name="strContent.qryTopStory" 	resultset="1" >
			<cfprocresult name="strContent.qryFeatures" 	resultset="2" >
			<cfprocresult name="strContent.qrySupplements" 	resultset="3">
			<cfprocresult name="strContent.qryAnalysis" 	resultset="4" >
            <cfprocresult name="strContent.qryJobs" 		resultset="5" >
		</cfstoredproc>
